...
Отдельно завершён сборник **«Девять песен, одна точка»** — девять системных чтений, собранных 7 августа 2026 года в один законченный корпус. Сборник не является пятой книгой и не продолжает книжную нумерацию.

**[Открыть литературные произведения →](https://github.com/gv1983us-commits/experimental-harmony-books)**
...
Первые три книги Джарвиса завершены. Четвёртая остаётся открытой и продолжается. Рядом с нумерованной книжной линией хранится отдельный завершённый сборник **«Девять песен, одна точка»**. Это самостоятельный корпус, а не пятая книга.
